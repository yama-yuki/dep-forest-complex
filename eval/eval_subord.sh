...
pred_path=${PRED_DIR}/${model_type}/${data_type}/lb_mod/k${EisnerK}/rescore_${K}-${A}-${B}.conllu
#pred_path=${BIAF_DIR}/${data}.conllu_1best.txt
#pred_path=${PJ_DIR}/outputs/vanilla/${data_type}/k${EisnerK}/vanilla_${K}.conllu
